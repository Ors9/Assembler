 ...
 */
void second_phase(MachineCode ** head_mach_code , LABEL * head_label , char * file_name_without_suffix , int IC , int DC,MachCodeData **mach_data_head){
    ...
    */
    if(final_result == SUCCESS){
        translation_unit(*head_mach_code,head_label ,file_name_without_suffix ,IC , DC , *mach_data_head);
    }
