 ...
 */
typedef struct Mila{
    unsigned short bit_field; /* Binary code in bit field */
}Mila;


/**
 * Struct for representing machine code with address, binary code, source and destination labels, and types.
 */
